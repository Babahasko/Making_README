...
# 5.Используйте html
Как мы рассматривали с вами выше, внутри можно использовать HTML. Не все функции, но большинство. Рекомендуется всё же придерживаться разметки, но некоторые функции, такие как выравнивание текста и изображений по центру, в readme доступны только с использованием HTML.

<p align="center">
<img src="./readme_assets/html.png" width="80%"></p>
...
Пример readme рассматриваемого проекта вы можете найти тут [паук](https://github.com/silent-lad/VueSolitaire)
